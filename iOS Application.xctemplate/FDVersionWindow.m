...
- (void)_initializeVersionWindow
{
	...
	//Add gesture for open feedbackview
	UITapGestureRecognizer *tapGestureRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(openFeedbackView)];
	tapGestureRecognizer.numberOfTapsRequired = 2;
	[buildLabel addGestureRecognizer:tapGestureRecognizer];
	buildLabel.userInteractionEnabled = YES;
